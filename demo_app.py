...
# --- DATABASE CONSTANTS ---
DB_NAME = "demo_showcase_v3.db"

# ==========================================
# 1. HELPER FUNCTIONS (The Exact Math from Real App)
# ==========================================
...
def reconstruct_daily_pnl(trades_df):
    ...
    for _, trade in trades.iterrows():
        ...
        # Distribute PnL over days (simplified linear for demo speed)
