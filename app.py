...
# --- DEBUG BANNER ---
st.info("✅ RUNNING VERSION: v137.1 (Fix: Strategies Tab Blank Screen Resolved)")
...
with tab_rules:
    ...
    * **Structure:** Multi-trade portfolio strategy.
    ...
    """)
    st.divider()
    st.caption("Allantis Trade Guardian v137.1 (Fix: Strategies Tab Blank Screen Resolved)")
